...
const players = [
  ["ぽんた", "ponta", 1, 1, 15420, 3220, [2, 8, 4, 6, 1, 0]],
  ["NO11社長", "akane-mami", 2, 2, 13210, 2890, [1, 7, 5, 5, 2, 1]],
  ["オータカ社長", "otaka", 3, 3, 11880, 2410, [0, 5, 6, 4, 3, 0]],
  ["いーゆー", "eu", 4, 4, 9800, 1990, [1, 4, 7, 3, 1, 2]],
] as const;
