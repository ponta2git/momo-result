...
object GameTitlesEndpoints:
  val list: PublicEndpoint[Option[String], ErrorInfo, GameTitleListResponse, Any] =
    endpoint.get
      .in("api" / "game-titles")
...
object IncidentMastersEndpoints:
  val list: PublicEndpoint[Option[String], ErrorInfo, IncidentMasterListResponse, Any] =
    endpoint.get
