...
async fn run_ocr_r2_endurance(arguments: OcrR2EnduranceArgs) -> Result<(), String> {
    ...
    let report = crate::ocr::endurance::run_r2_endurance(&R2OcrEnduranceRequest {
        ...
        thresholds: R2OcrEnduranceThresholds {
            ...
            download_milliseconds: arguments.maximum_download_ms,
            ocr_p99_milliseconds: arguments.maximum_ocr_p99_ms,
            ocr_milliseconds: arguments.maximum_ocr_ms,
            total_milliseconds: arguments.maximum_total_ms,
        },
...
async fn run_ocr_local_endurance(arguments: OcrLocalEnduranceArgs) -> Result<(), String> {
    let report = crate::ocr::endurance::run_local_endurance(&LocalOcrEnduranceRequest {
        ...
        thresholds: LocalOcrEnduranceThresholds {
            child_peak_basis_points: arguments.maximum_child_peak_basis_points,
            runtime_peak_basis_points: arguments.maximum_runtime_peak_basis_points,
            input_p99_milliseconds: arguments.maximum_input_p99_ms,
            input_milliseconds: arguments.maximum_input_ms,
            ocr_p99_milliseconds: arguments.maximum_ocr_p99_ms,
            ocr_milliseconds: arguments.maximum_ocr_ms,
            total_milliseconds: arguments.maximum_total_ms,
        },
