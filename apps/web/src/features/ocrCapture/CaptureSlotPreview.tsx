    ...
    >
      {slot.previewUrl ? (
        <>
          ...
          />
          {slot.source ? (
            <span className="absolute bottom-2 left-2 rounded-sm border border-[var(--color-text-inverse)]/15 bg-[var(--color-surface-inverse)]/80 px-2 py-0.5 text-xs font-semibold text-[var(--color-text-inverse)]">
