...
export function makeSeriesComparisonPlayOrderDrilldownResponse(
  memberId = "member_ponta",
): SeriesComparisonDrilldownResponse {
  const player = players.find((item) => item.memberId === memberId) ?? players[1] ?? players[0]!;
  return {
    ...
    playOrderRankHistory: {
      averageTrendRows: [
        {
          cumulativeAverageRankByPlayOrder: 2,
          heldEventId: "held_2026_05_10",
          matchId: "play-order-match-1",
          matchIndex: 1,
          matchNoInEvent: 1,
          playedAt: "2026-05-10T12:00:00.000Z",
          playOrder: 1,
          playOrderOccurrenceIndex: 1,
          rank: 2,
        },
        {
          cumulativeAverageRankByPlayOrder: 4,
          heldEventId: "held_2026_05_10",
          matchId: "play-order-match-2",
          matchIndex: 2,
          matchNoInEvent: 2,
          playedAt: "2026-05-10T13:00:00.000Z",
          playOrder: 2,
        ...
        {
          cumulativeAverageRankByPlayOrder: 1.5,
          cumulativeAverageRankDeltaByPlayOrder: -0.5,
          heldEventId: "held_2026_05_17",
          matchId: "play-order-match-3",
          matchIndex: 3,
          matchNoInEvent: 1,
          playedAt: "2026-05-17T12:00:00.000Z",
          playOrder: 1,
          playOrderOccurrenceIndex: 2,
          previousCumulativeAverageRankByPlayOrder: 2,
          rank: 1,
        },
        {
          cumulativeAverageRankByPlayOrder: 4,
          heldEventId: "held_2026_05_17",
          matchId: "play-order-match-4",
          matchIndex: 4,
          matchNoInEvent: 2,
          playedAt: "2026-05-17T13:00:00.000Z",
          playOrder: 3,
        ...
        {
          cumulativeAverageRankByPlayOrder: 3,
          cumulativeAverageRankDeltaByPlayOrder: -1,
          heldEventId: "held_2026_05_24",
          matchId: "play-order-match-5",
          matchIndex: 5,
          matchNoInEvent: 1,
          playedAt: "2026-05-24T12:00:00.000Z",
          playOrder: 2,
          playOrderOccurrenceIndex: 2,
          previousCumulativeAverageRankByPlayOrder: 4,
          rank: 2,
        },
      ],
      playOrderRows: [
        ...
        },
        {
          ...
          rankDistribution: [
            { count: 0, rank: 1, rate: 0 },
            { count: 0, rank: 2, rate: 0 },
            { count: 0, rank: 3, rate: 0 },
            { count: 1, rank: 4, rate: 1 },
          ],
        },
        {
          lowerHalfCount: 0,
      ...
      summary: {
        ...
        countsByPlayOrder: [
          { matchCount: 2, playOrder: 1 },
          { matchCount: 2, playOrder: 2 },
          { matchCount: 1, playOrder: 3 },
          { matchCount: 0, playOrder: 4 },
        ],
        currentAverageRank: 2.6,
        spread: 2.5,
        targetCount: 5,
        worstPlayOrder: 3,
        worstPlayOrderAverageRank: 4,
      },
    },
    player,
    schemaVersion: 1,
