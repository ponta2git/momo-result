...
export type TrendSeries = NonNullable<
  SeriesComparisonResponse["trends"]["rankCumulativeAverage"]
>[number];
...
export type HeadToHeadEntry = NonNullable<
  SeriesComparisonResponse["headToHead"]["entries"]
>[number];
