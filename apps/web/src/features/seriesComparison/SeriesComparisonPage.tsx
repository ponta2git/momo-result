...
const perspectiveItems = [
  ...
  {
    description: "選択中範囲の全試合から、荒れ試合、直近8戦、第n試合別の傾向を見ます。",
    id: "flow",
    label: "流れと勢い",
    sections: [
...
function isSeriesComparisonViewId(value: string): value is SeriesComparisonViewId {
  return perspectiveItems.some((item) => item.id === value);
}
