...
export function CaptureSlotFeedback({
  ...
  return (
    <>
      ...
      {canRefreshStatus ? (
        <div className="grid gap-2 rounded-sm border border-[var(--color-border)] bg-[var(--color-surface-subtle)] p-3 text-sm text-[var(--color-text-primary)] sm:grid-cols-[minmax(0,1fr)_auto] sm:items-center">
...
function CaptureMismatchAlert({ detectedKind }: { detectedKind?: SlotKind | undefined }) {
  return (
    <div
      className="rounded-sm border border-[var(--color-warning)]/60 bg-[var(--color-warning)]/20 p-3 text-sm text-[var(--color-text-primary)]"
      role="alert"
    >
...
function CaptureTransportError({
  ...
  return (
    <div
      className="rounded-sm border border-[var(--color-danger)]/45 bg-[var(--color-danger)]/10 p-3 text-sm text-[var(--color-text-primary)]"
      role="alert"
    >
