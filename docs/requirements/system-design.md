...
| CSV/TSV export量 | API log | `match_export_completed`, `match_export_rate_limited` |
| OAuth provider / session負荷 | API log | `auth_login_completed`, `auth_login_rate_limited`, `auth_callback_rejected` |
